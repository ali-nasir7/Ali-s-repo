...
Asal's unique approach integrates her pharmaceutical background with restorative practices like vibration and intentional space-holding. By offering a concierge model, she provides a bespoke experience that combines clinical insight with a deep understanding of how chronic stress impacts the body. A TEDx speaker and consultant for corporations, she designs immersive wellness experiences centered on human connection and intentional longevity.`,
  ...
  {
    name: "Melissa Lazere, RN, BSN",
    role: "Lead Longevity Nurse",
    experience: "20+ Years",
    spec: "Critical Care · Hydration Therapy · Longevity Medicine",
    image: "/resources/melissaphoto.png",
    animatePhoto: false,
    bio: `Melissa is a critical care registered nurse with more than 20 years of experience in nursing. Her background includes extensive experience in critical care where she developed a passion for patient-centered care and wellness optimization.

At LivLongMD, Melissa combines her clinical expertise with a personalized approach to help patients feel their best through hydration therapy, wellness infusions, and preventative health support. She is currently completing her Adult-Gerontology Acute Care Nurse Practitioner degree, further expanding her knowledge in critical care and longevity medicine.

Known for her compassionate bedside manner and attention to detail, Melissa is dedicated to creating a welcoming experience where patients feel supported and empowered in their health journey.`,
  },
  {
    name: "Umar Iqbal, MD",
    role: "Medical Director",
    ...
    animatePhoto: true,
    bio: `Dr. Umar Iqbal is the Medical Director of LivLong MD, where he bridges high-level clinical expertise with a science-meets-soul philosophy. A Board-Certified Physician specializing in a Board-Certified Physician with expertise in longevity, wellness, hormone optimization and regenerative medicine, Dr. Iqbal moves beyond symptom management to address the root causes of mitochondrial dysfunction and metabolic imbalance.
    ...
    <section id="about" className="relative scroll-mt-24">
      <div className="mx-auto max-w-[1440px] px-6 md:px-10 lg:px-16 py-24 md:py-32">
        <div className="max-w-2xl mb-20">
          <div className="label text-eucalyptus !text-xl mb-5">The Practitioners</div>
          <h2 className="text-4xl md:text-6xl tracking-tightest font-medium text-charcoal leading-[1.05]">
            Care, shaped by intention and depth
          </h2>
        </div>
